...
# if ans == "y":
#     print(logo)
#     default_cards = random.sample(cards,1)
#     default_score = default_cards[0]

#     def blackJack(your_cards,your_score):
#         nextCard = random.choice(cards)
#         your_cards.append(nextCard)
#         your_score += nextCard
...
#     blackJack(default_cards,default_score)
